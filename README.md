...
* `03-performance_metrics.R` uses the model objects to calculate important summary statistics, like F1, precision, recall, etc., which are used in the paper, and saves them to the `ModelMetrics.RData` file. This file is provided for you to load into R and view the results, create tables, graphs, and other visualizations.
